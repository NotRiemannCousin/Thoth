...
namespace Thoth::Dsa {
    ...
    constexpr LinearMap<KeyT, ValT, Pred>::find_position(const LookupKeyT& key) {
        return std::ranges::lower_bound(_data, key, _compare, &value_type::first);
    }
    ...
    constexpr typename LinearMap<KeyT, ValT, Pred>::iterator       LinearMap<KeyT, ValT, Pred>::begin()  { return _data.begin(); }
    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr typename LinearMap<KeyT, ValT, Pred>::iterator       LinearMap<KeyT, ValT, Pred>::end()    { return _data.end(); }
    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr typename LinearMap<KeyT, ValT, Pred>::const_iterator LinearMap<KeyT, ValT, Pred>::begin() const { return _data.cbegin(); }
    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr typename LinearMap<KeyT, ValT, Pred>::const_iterator LinearMap<KeyT, ValT, Pred>::end() const   { return _data.cend(); }
    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr typename LinearMap<KeyT, ValT, Pred>::const_iterator LinearMap<KeyT, ValT, Pred>::cbegin() const { return _data.cbegin(); }
    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr typename LinearMap<KeyT, ValT, Pred>::const_iterator LinearMap<KeyT, ValT, Pred>::cend() const   { return _data.cend(); }

    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr bool LinearMap<KeyT, ValT, Pred>::empty() const { return _data.empty(); }
    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr typename LinearMap<KeyT, ValT, Pred>::size_type LinearMap<KeyT, ValT, Pred>::size() const { return _data.size(); }
    ...
    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr typename LinearMap<KeyT, ValT, Pred>::iterator LinearMap<KeyT, ValT, Pred>::erase(iterator pos) { return _data.erase(pos); }
    template<class KeyT, class ValT, class Pred> requires strong_order_relation<KeyT, Pred>
    constexpr typename LinearMap<KeyT, ValT, Pred>::iterator LinearMap<KeyT, ValT, Pred>::erase(const_iterator pos) { return _data.erase(pos); }
    ...
    constexpr typename LinearMap<KeyT, ValT, Pred>::iterator LinearMap<KeyT, ValT, Pred>::find(const LookupKeyT& key) {
        iterator it{ find_position(key) };
        return is_equivalent(it, key) ? it : _data.end();
    }
    ...
    ValT& LinearMap<KeyT, ValT, Pred>::operator[](LookupKeyT&& key) {
        ...
        auto newIt{ _data.emplace(it, KeyT{std::forward<LookupKeyT>(key)}, mapped_type{}) };
        return newIt->second;
   }
}
